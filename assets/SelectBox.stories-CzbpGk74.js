import{s as e}from"./iframe-CN-2U1D8.js";import{t}from"./react-Y-6QNYsc.js";import{t as n}from"./jsx-runtime--jJlx6pC.js";e(t(),1);var r=n(),i=({label:e,options:t,error:n,helperText:i,...a})=>(0,r.jsxs)(`div`,{className:`flex flex-col gap-1.5 w-full`,children:[(0,r.jsx)(`label`,{className:`text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1`,children:e}),(0,r.jsxs)(`div`,{className:`relative`,children:[(0,r.jsx)(`select`,{...a,className:`
  ...
  decorators: [Story => <div className="w-[220px]">
                <Story />
            </div>]
