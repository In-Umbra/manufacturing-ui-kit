import{s as e}from"./iframe-CN-2U1D8.js";import{t}from"./react-Y-6QNYsc.js";import{t as n}from"./jsx-runtime--jJlx6pC.js";e(t(),1);var r=n(),i=({label:e,value:t,unit:n,trend:i})=>(0,r.jsxs)(`div`,{className:`bg-white p-4 rounded-lg border border-gray-200 shadow-sm`,children:[(0,r.jsx)(`p`,{className:`text-[10px] font-bold text-gray-400 uppercase tracking-wider`,children:e}),(0,r.jsxs)(`div`,{className:`flex items-baseline gap-1 mt-1`,children:[(0,r.jsx)(`span`,{className:`text-2xl font-black text-gray-900`,children:t}),n&&(0,r.jsx)(`span`,{className:`text-xs font-bold text-gray-400`,children:n})]}),i&&(0,r.jsxs)(`div`,{className:`mt-2 text-[10px] font-bold flex items-center ${i.isUp?`text-green-600`:`text-red-600`}`,children:[i.isUp?`▲`:`▼`,` `,i.value,`%`,(0,r.jsx)(`span`,{className:`text-gray-400 ml-1 font-normal text-[9px]`,children:`vs yesterday`})]})]});i.__docgenInfo={description:``,methods:[],displayName:`KpiCard`,props:{label:{required:!0,tsType:{name:`string`},description:``},value:{required:!0,tsType:{name:`union`,raw:`string | number`,elements:[{name:`string`},{name:`number`}]},description:``},unit:{required:!1,tsType:{name:`string`},description:``},trend:{required:!1,tsType:{name:`signature`,type:`object`,raw:`{
    value: number;
    isUp: boolean;
  ...
  decorators: [Story => <div className="w-[240px] bg-gray-50 p-6">
                <Story />
            </div>]
